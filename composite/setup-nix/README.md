...
Ensure Nix is available before project-shell setup. Supports GitHub.com Linux X64 and ARM64
runners 2.336.0+.
...
Nix configuration. This action does not install devenv, secretspec or project tools. See
